...
Values(3,'Cofanetto Harry Potter','Il cofanetto contiene tutti i libri di Harry Potter, il Best seller che ha incantato generazioni di ragazzi di tutte le età.',
...
insert into Oggetti ( idVenditore, nomeOggetto, descrizione, categoria, quantita, prezzoUnita, indirizzoImg)
Values(4,'Monitor LG 4k','potrete vedere ogni dettaglio in questo schermo 31" 4K LG, in grado di mostrare 157 pixel per pollice e colore a 10-bit',
